...
TERRAIN.Generate = function(  ){
    ...
    this.textures = [];
    this.maps = ["level0", "level1", "level2", "level3", "level4", "diffuse1", "diffuse2", "normal", "normal"]
...
TERRAIN.Generate.prototype = {
    ...
    init:function (obj, Parent) {
        ...
        this.size = obj.size || [2000, 30, 2000];
        this.isAutoMove = obj.AutoMove || true;
        this.isMove = obj.Move || true;
        ...
        this.W = window.innerWidth;// || 512;
        this.H = window.innerHeight;// || 512;
    ...
    start:function() {
       ...
       // this.uniformsTerrain[ "envMap" ].value = this.envMap;
        ...
        this.uniformsTerrain[ "tCube" ].value = sky;
